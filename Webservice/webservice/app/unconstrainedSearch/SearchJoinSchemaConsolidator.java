...
/**
 * 
 * Merges tables based on the schema correspondences that are provided. First, the tables are transformed into a global schema (by merging all attributes). 
 * Then, the union of all transformed tables is created.
 * 
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class SearchJoinSchemaConsolidator {
	 ...
	 */
	public SearchJoinSchemaConsolidator() {
		addProvenance = false;
	}
	 ...
	 * @param web
	 */
	public SearchJoinSchemaConsolidator(Map<Integer, Table> web) {
...
//			String newHeader = headers.getMode();
	...
	public Pair<Table, Table> consolidate(
...
//		SaveTableToCsv.save(queryConsolidated, "queryConsolidated1");
		...
		return new Pair<Table, Table>(queryConsolidated, tablesConsolidated);
	}
