...
import de.uni_mannheim.informatik.dws.winter.matching.blockers.generators.RecordValueGenerator;
 ...
 *
 */
public class WebTableRowEntityLabelValueGenerator extends RecordValueGenerator<MatchableTableRow> {
	...
	public void generateBlockingKeys(MatchableTableRow record,
		...
		if(record.hasColumn(record.getSubjectColumnIndex())) {
			Object value = record.get(record.getSubjectColumnIndex());
			if(value!=null) {
