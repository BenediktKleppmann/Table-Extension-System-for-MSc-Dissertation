...
import uploadTable.CustomMatchingRules.KeyColumnComparatorJaccard;
import uploadTable.CustomMatchingRules.NonKeyColumnComparator_withDType;
import uploadTable.customSimilarity.InverseExponentialDateSimilarity;
import uploadTable.customSimilarity.NumericDeviationSimilarity;
...
//							System.out.println(a1.getColumnIndex() + "," +  c.getFirstRecord().getRowNumber() + "," +  String.valueOf(c.getFirstRecord().get(a1.getColumnIndex())) + "," +  a2.getColumnIndex() + "," +  c.getSecondRecord().getRowNumber() + "," +  String.valueOf(c.getSecondRecord().get(a2.getColumnIndex())) + "," +  String.valueOf(similarity)   );
							return similarity;
						}
					};
