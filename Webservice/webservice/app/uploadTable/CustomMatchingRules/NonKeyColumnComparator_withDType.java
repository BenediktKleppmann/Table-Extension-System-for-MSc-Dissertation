...
//					System.out.println(typeOfComparison + "_comparison," + columnIndex1 + "," + record1.getRowNumber() + "," + record1.get(columnIndex1) + "," + columnIndex2 + "," + record2.getRowNumber() + "," + record1.get(columnIndex2) + "," + String.format(Locale.ROOT, "%.4f", similarity) );
//					if (similarity !=0.0){
