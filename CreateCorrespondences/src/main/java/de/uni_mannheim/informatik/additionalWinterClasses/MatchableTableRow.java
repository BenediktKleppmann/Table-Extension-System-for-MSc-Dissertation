package de.uni_mannheim.informatik.additionalWinterClasses;
...
//		this.values = row.getValueArray();
	...
	public MatchableTableRow(TableRow row, int tableId, MatchableTableColumn[] schema) { 
		...
		this.subjectColumnIndex = row.getTable().getSubjectColumnIndex();
...
//		this.values = row.getValueArray();
	...
	public MatchableTableRow(String identifier, MatchableTableColumn[] schema) { 
		this.tableId = -1;
		this.id = identifier;
		this.rowNumber = -1;
		this.rowLength = schema.length;
